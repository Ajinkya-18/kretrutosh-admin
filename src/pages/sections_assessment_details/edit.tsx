...
export const SectionsAssessmentDetailsEdit = () => {
            ...
            <>
                ...
                {record?.parent_slug && (
                    <Button 
                        ...
                        ghost 
                        icon={<Eye size={16} />} 
                        onClick={() => window.open(`https://kretrutosh.com/assessments/${record.parent_slug}`, '_blank')}
                    >
                        View Live Page
                    </Button>
                )}
    ...
    >
      <Form {...formProps} layout="vertical">
        ...
        <div className="grid grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg mb-6 border border-gray-200">
             <Form.Item label="Parent Assessment (Slug)" name="parent_slug">
